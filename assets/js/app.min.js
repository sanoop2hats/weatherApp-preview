...
var weather = {
    ...
    getWeather: function (latitude, longitude) {
        ...
        fetch(api)
            ...
            .then(function (data) {
                // console.log(data);
                currentTemp.value = Math.floor(data.main.temp - 273);
                highTemp.value = Math.floor(data.main.temp_max - 273);
                lowTemp.value = Math.floor(data.main.temp_min - 273);
    ...
    dayForecast: function (forecast) {
        ...
        for (let i = 8; i < weather.list; i += 8) {
            ...
            let forecastDate = new Date(weather.listArray[i].dt * 1000).toDateString(undefined, 'Asia/Kolkata');
            var arr1 = forecastDate.split(' ');
            var arr2 = arr1[1].split(',');
            var arr3 = arr1[2].split(',');
            day.innerText = arr2[0] + ', ' + arr3[0];
            div.appendChild(day);
